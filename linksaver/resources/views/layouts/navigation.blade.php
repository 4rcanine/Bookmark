...
{{-- UPDATED: Added shadow-sm for subtle separation --}}
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    {{-- Consider adding LinkSaver+ text or a custom logo component --}}
                    <a href="{{ route('bookmarks.index') }}" class="flex items-center gap-2 text-gray-800 dark:text-gray-200 font-semibold">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    {{-- Removed Dashboard Link as it redirects to Bookmarks --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
             {{-- ... (responsive settings remain the same) ... --}}
             <div class="px-4">
